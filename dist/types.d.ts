 ...
 * Logic operators
 */
export type LogicOperator = '==' | '!=' | '<' | '>' | '<=' | '>=' | 'contains' | 'startsWith' | 'endsWith' | 'matches' | 'in' | 'notIn' | 'exists' | 'notExists';
/**
 ...
 */
export type SpreadsheetCellType = 'input' | 'output' | 'logic' | 'transformation' | 'decision' | 'reference' | 'constant' | 'formula' | 'metadata';
/**
