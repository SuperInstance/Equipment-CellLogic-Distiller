...
class SpreadsheetVisualizer {
     ...
     */
    extractCellValue(tile, columnId) {
        switch (columnId) {
            case 'name':
                return tile.name;
            case 'type':
    ...
    generateFormula(tile, columnId) {
        ...
        if (columnId === 'conditions' && tile.decisionLogic.conditions.length > 0) {
            const conditions = tile.decisionLogic.conditions.map(c => `${c.left} ${c.operator} ${c.right}`);
     ...
     */
    getCellFormatting(type, confidence) {
     ...
     */
    generateComments(tile, columnId) {
        const comments = [];
        if (columnId === 'rule') {
     ...
     */
    reverseEngineerCell(cell, tiles) {
     ...
     */
    createSummaryVisualization(tiles) {
        const lines = [];
...
exports.SpreadsheetVisualizer = SpreadsheetVisualizer;
exports.default = SpreadsheetVisualizer;
//# sourceMappingURL=SpreadsheetVisualizer.js.map